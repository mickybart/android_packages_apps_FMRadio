...
public class FmUtils {
    ...
    private static final String FM_BAND = "fm_band";
    public static final int FM_BAND_US = 0;
    public static final int FM_BAND_EU = 1;
    public static final int FM_BAND_CH = 2;
    public static final int FM_BAND_JA = 3;
     ...
     * @return true for speaker mode, false for non speaker mode
     */
    public static int getFmBandSelected(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);

        return prefs.getInt(FM_BAND, FM_BAND_US);
    }
     ...
     * @param band
     */
    public static void setFmBandSelected(Context context, int band) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(FM_BAND, band);
        editor.commit();
    }
}
